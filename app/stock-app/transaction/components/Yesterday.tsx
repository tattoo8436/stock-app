...
const Yesterday = (props: IProps) => {
  ...
  return (
    <div className="yesterday">
      <div className="yesterday__title">{t("transaction.label.yesterday")}</div>

      <div className="yesterday__content">
        {transaction?.yesterday?.map((i) => {
          return (
            <div key={i.id}>
              <div
                className="yesterday__content__item"
